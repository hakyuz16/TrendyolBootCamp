...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  5 14:18:31 2022
...
class recoSys:
    ...
    def __init__(self, alpha: any = 0.01, iteration : any = 2000):
        """
        :param lam:
        :param alpha: 
        :param iteration:
    ...
    def fit(self, r: np.ndarray):
        ...
        for i in trange(self.iteration):
            ...
            for user in range(m):
                ...
                objective += np.sum((y_i - y_pred_b_i)**2) 
            ...
            for item in range(n):
                ...
                objective += np.sum((y_j - y_pred_b_j)**2 )
